...
class GeneticAlgorithm:
    ...
    def children_production(self, crossover_number, parents):
        ...
        children = []
        for i in range(crossover_number):
            crossover_method = random.randint(0, 2)
            if crossover_method == 0:
                self.crossover_method = 'weight'
            elif crossover_method == 1:
                self.crossover_method = 'neuron'
            elif crossover_method == 1:
                self.crossover_method = 'layer'
    ...
    def mutation_production(self, networks, mutation_number, population_size):
        ...
        for i in range(mutation_number):
            ...
            if mutation_method == 0:
                self.mutation_method = 'weight'
            elif mutation_method == 1:
                self.mutation_method = 'neuron'
